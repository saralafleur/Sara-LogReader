...
{
    public class RegularExpressionTesterViewModel
    {
        public RegularExpressionTesterWindow View { get; set; }

        public string Value { get; set; }

        public Action<Value> UpdateRegularExpressionEvent;

        public RegularExpressionTesterViewModel(RegularExpressionTesterWindow view)
        {
            View = view;
        }
